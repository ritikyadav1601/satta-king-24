    ...
    <>
      <section className="p-1">
        <div className="responsive-copy text-center font-bold border-2 border-blue-600 rounded-xl mt-1 py-2 px-2">
          ...
          <p className="text-blue-800 text-lg md:text-xl">SATTA KING</p>
          <p className="text-green-500 text-lg md:text-xl">ADD</p>
          <button className="px-2 bg-red-500 text-white py-2 rounded-lg">DELHI SATTA BAZAR</button>
        </div>
      </section>
      <section>
      ...
      <div className="responsive-copy">
        <div className="max-w-6xl mx-auto">
          <div className="md:flex justify-between md:space-x-6">
            <div className="w-full sk24-khaiwal-card">
              ...
              <div className="mt-2">
                <a href={`https://wa.me/${whatsapp}`} target="_blank" rel="noopener noreferrer" className="bg-green-500 text-white px-5 py-2 rounded-xl my-1 hover:bg-green-600 inline-flex text-2xl items-center">
                  <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 448 512" className="text-4xl mr-1" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
